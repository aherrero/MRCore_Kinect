...
class NeoKinect: public MobileRobot
{
public: 
	NeoKinect():MobileRobot("NeoKinect")
	{
		base=new Pioneer3ATSim;
                kinectsim=new KinectSim;
                kinectsim->LinkTo(base);
                kinectsim->setColor(150,150,0);
                kinectsim->setRelativePosition(Vector3D(0.1,0,0.4));
